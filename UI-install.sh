...
###
#
# Original. Author: Maël # Date: 2021/03/14
# Updates Change Author Jacob M 2025/03/08
# Desc:
...
WGUI_LINK="https://github.com/ngoduykhanh/wireguard-ui/releases/download/v0.6.2/wireguard-ui-v0.6.2-linux-amd64.tar.gz" # Link to the last release
